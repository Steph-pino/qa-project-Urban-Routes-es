...
class Helpers:
    ...
    def retrieve_phone_code(driver) -> str:
        ...
        me marca error. Acabo de revisar con Ramses para ponerle ese @staticmethod y quitaron las alertas en get_log y
        ...
        Los aserts los dejo en # porque no me funcionana por más que intento opciones"""
